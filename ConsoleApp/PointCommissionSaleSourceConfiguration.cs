...
namespace ConsoleApp
{
    ...
    public class PointCommissionSaleSourceConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PointCommissionSaleSource>
    {
        public PointCommissionSaleSourceConfiguration()
            : this("dbo")
        {
        }

        public PointCommissionSaleSourceConfiguration(string schema)
        {
            ToTable("PointCommissionSaleSource", schema);
            HasKey(x => x.UniqueId);
