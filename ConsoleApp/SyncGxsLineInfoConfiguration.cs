...
namespace ConsoleApp
{
    ...
    public class SyncGxsLineInfoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SyncGxsLineInfo>
    {
        public SyncGxsLineInfoConfiguration()
            : this("dbo")
        {
        }

        public SyncGxsLineInfoConfiguration(string schema)
        {
            ToTable("SyncGXSLineInfo", schema);
            ...
            Property(x => x.RenterUniqueId).HasColumnName(@"RenterUniqueID").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            ...
            Property(x => x.TempMerchantCode).HasColumnName(@"TempMerchantCode").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
        }
    }
