...
namespace ConsoleApp
{
    ...
    public class SyncProductStockConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SyncProductStock>
    {
        public SyncProductStockConfiguration()
            : this("dbo")
        {
        }

        public SyncProductStockConfiguration(string schema)
        {
            ToTable("SyncProductStock", schema);
