...
namespace ConsoleApp
{
    ...
    public class SyncDevicePushLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SyncDevicePushLog>
    {
        public SyncDevicePushLogConfiguration()
            : this("dbo")
        {
        }

        public SyncDevicePushLogConfiguration(string schema)
        {
            ToTable("SyncDevicePushLog", schema);
            ...
            Property(x => x.SendData).HasColumnName(@"SendData").HasColumnType("nvarchar(max)").IsOptional();
            Property(x => x.ReceiveData).HasColumnName(@"ReceiveData").HasColumnType("nvarchar(max)").IsOptional();
