...
namespace ConsoleApp
{
    ...
    public class SyncPointCommissionSaleSourceConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SyncPointCommissionSaleSource>
    {
        public SyncPointCommissionSaleSourceConfiguration()
            : this("dbo")
        {
        }

        public SyncPointCommissionSaleSourceConfiguration(string schema)
        {
            ToTable("SyncPointCommissionSaleSource", schema);
            ...
            Property(x => x.AmountRemain).HasColumnName(@"AmountRemain").HasColumnType("decimal").IsOptional().HasPrecision(18,5);
