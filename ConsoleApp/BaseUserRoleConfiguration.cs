...
namespace ConsoleApp
{
    ...
    public class BaseUserRoleConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BaseUserRole>
    {
        public BaseUserRoleConfiguration()
            : this("dbo")
        {
        }

        public BaseUserRoleConfiguration(string schema)
        {
            ToTable("BASE_UserRole", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.CanGrant).HasColumnName(@"CanGrant").HasColumnType("bit").IsRequired();
            Property(x => x.InvalidDate).HasColumnName(@"InvalidDate").HasColumnType("datetime2").IsOptional();
