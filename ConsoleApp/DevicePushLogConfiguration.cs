...
namespace ConsoleApp
{
    ...
    public class DevicePushLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<DevicePushLog>
    {
        public DevicePushLogConfiguration()
            : this("dbo")
        {
        }

        public DevicePushLogConfiguration(string schema)
        {
            ToTable("DevicePushLog", schema);
            HasKey(x => x.UniqueId);
