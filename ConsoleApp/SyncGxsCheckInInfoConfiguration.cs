...
namespace ConsoleApp
{
    ...
    public class SyncGxsCheckInInfoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SyncGxsCheckInInfo>
    {
        public SyncGxsCheckInInfoConfiguration()
            : this("dbo")
        {
        }

        public SyncGxsCheckInInfoConfiguration(string schema)
        {
            ToTable("SyncGXSCheckInInfo", schema);
            HasKey(x => x.UniqueId);
            ...
            Property(x => x.TempGxsMachineId).HasColumnName(@"TempGXSMachineID").HasColumnType("int").IsOptional();
        }
    }
