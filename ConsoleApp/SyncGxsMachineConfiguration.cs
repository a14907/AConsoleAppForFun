...
namespace ConsoleApp
{
    ...
    public class SyncGxsMachineConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<SyncGxsMachine>
    {
        public SyncGxsMachineConfiguration()
            : this("dbo")
        {
        }

        public SyncGxsMachineConfiguration(string schema)
        {
            ToTable("SyncGXSMachine", schema);
            ...
            Property(x => x.DeviceId).HasColumnName(@"DeviceID").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            ...
            Property(x => x.TempMemberId).HasColumnName(@"TempMemberId").HasColumnType("int").IsOptional();
            Property(x => x.TempPartnerId).HasColumnName(@"TempPartnerId").HasColumnType("int").IsOptional();
            Property(x => x.TempUserId).HasColumnName(@"TempUserId").HasColumnType("int").IsOptional();
