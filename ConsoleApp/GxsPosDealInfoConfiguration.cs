...
namespace ConsoleApp
{
    ...
    public class GxsPosDealInfoConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<GxsPosDealInfo>
    {
        public GxsPosDealInfoConfiguration()
            : this("dbo")
        {
        }

        public GxsPosDealInfoConfiguration(string schema)
        {
            ToTable("GXSPosDealInfo", schema);
            HasKey(x => x.UniqueId);
            ...
            Property(x => x.SalesOrderId).HasColumnName(@"SalesOrderID").HasColumnType("uniqueidentifier").IsOptional();
